...
**Quotation Attribution**
  ...
  - The baseline algorithm is completed by running the 'baseline_attribution.ipynb' file. It takes a novel database from the 'cleaned_books' folder (does not require annotations) and puts annotations for each quotation. It stores this in the 'predicted_books/baseline' folder. 
